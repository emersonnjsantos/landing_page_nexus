      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <Link to="/">
          <motion.div
            ...
            className="text-xl font-display font-semibold tracking-tighter flex items-center gap-2 cursor-pointer"
          >
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          <button
            ...
            className="bg-soft-text text-white px-5 py-3 rounded-xl text-sm font-medium"
          >
            Vamos Conversar
          </button>
        </motion.div>
